...
import com.ozalp.sportcenter.business.abstracts.CoachLookupService;
...
@Service
@AllArgsConstructor
public class CoachManager implements CoachService, CoachLookupService {
    ...
    @Override
    public Result create(Coach coach) {
